        ...
        let createTable = ()=>{
            tableContainer.innerHTML = `
                <table class="table table-hover table-striped-columns m-3">
                    <tr>
                        <th colspan="3" class="stats-title rounded-2 text-white fs-4" style="background-color: rgb(231, 193, 227);">Events Statistics</th>
                    </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th colspan="3" class="stats-title rounded-2 text-white fs-4" style="background-color: rgb(231, 193, 227);">Upcoming events statistics by category</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th colspan="3" class="stats-title rounded-2 text-white fs-4" style="background-color: rgb(231, 193, 227);">Past events statistics by category</th>
                        </tr>
                        <tr>
                            <td><b>Categories</b></td>
                            <td><b>Revenues</b></td>
